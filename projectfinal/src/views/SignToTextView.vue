...
export default {
    ...
    methods: {
        ...
        changeCamera(event) {
            ...
            const selectedDevice = this.videoDevices.find(device => device.label === selectedDeviceName);
            if (selectedDevice) {
                this.selectCamera(selectedDevice.deviceId);
            }
        },
        async loadCameras() {
            try {
                ...
                <div class="device-selection-container">
                    <div class="device-selection camera-selection">
                        ...
                        <select id="cameraSelect" @change="changeCamera" class="device-dropdown">
                            <option v-for="device in videoDevices" :key="device.deviceId" :value="device.label">{{
                                device.label }}</option>
                        </select>
                    </div>
                </div>
